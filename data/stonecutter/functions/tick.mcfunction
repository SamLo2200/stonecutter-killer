...
execute store success score bool stonecutter_exe_success as @e[type=!minecraft:villager, type=!minecraft:item] at @s if block ~ ~ ~ minecraft:stonecutter run damage @s 3 minecraft:magic by @a[sort=nearest, limit=1]
